...
namespace WPFUserInterface
{
    ...
    public partial class MainWindow : Window
    {
        ...
        void cancelOperation_Click(object sender, RoutedEventArgs e) => cts.Cancel();
        ...
        private void PrintResults(List<WebsiteDataModel> results)
        {
            ...
            {
                resultsWindow.Text += $"{ item.WebsiteUrl } downloaded:" +
                    $"{ item.WebsiteData.Length } characters long.{ Environment.NewLine }";
            }
        }
    }
}